...
## 📝 Your Notes
Learned that the ...props is just a syntactic sugar to suggest the objects contained within
...objectName. The ordering of this matters and can be overwritten. Additionally,
JSX just renders down into a createElement and Babel must be used to translate that for compilation.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=danaimone%40gmail.com).
