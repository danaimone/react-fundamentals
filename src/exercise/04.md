...
Wrapping a JSX element with <> is syntactic sugar for
using 
```JSX 
<React.Fragment></React.Fragment>
```

propTypes allow us to do data validation for our properties. PropTypes.<type>.isRequired forces
that prop to be provided. If we're using TypeScript, these check are not really necessary, but should
exist in all non-typescript components otherwise.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=danaimone%40gmail.com).
